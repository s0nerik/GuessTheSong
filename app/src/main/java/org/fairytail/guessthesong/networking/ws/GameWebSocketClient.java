...
//
//        if (socketMessage.type == SocketMessage.Type.REQUEST) {
//            switch (socketMessage.message) {
//                case CLIENT_INFO:
//                    String info = gson.toJson(clientInfo, ClientInfo.class);
//                    send(gson.toJson(new SocketMessage(OFFER, SocketMessage.Message.CLIENT_INFO, info)));
//                    break;
//                default:
//                    Debug.e("Can't process message: "+socketMessage.message.name());
//            }
//        } else if (socketMessage.type == OFFER) {
//            switch (socketMessage.message) {
//                case CLIENT_INFO:
...
////                                    send(gson.toJson(new SocketMessage(OFFER, PREPARE_AND_SEEK, OK)));
////                                }
////                            }
////                            );
...
////                                }
////                            });
//                            p -> send(gson.toJson(new SocketMessage(OFFER, PREPARE_AND_SEEK, OK)))
//                    );
//                    break;
//                case PLAYBACK_START:
